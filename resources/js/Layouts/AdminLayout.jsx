    ...
    return (
        <div style={{ width: '100%', height: '100%', background: t.sidebar, display: 'flex', flexDirection: 'column', borderRight: `1px solid ${t.sidebarBorder}`, overflow: 'hidden' }}>
            ...
            <nav style={{ flex: 1, padding: '8px 6px', overflowY: 'auto', overflowX: 'hidden' }}>
                {NAV.map(group => <div key={group.group} style={{ marginBottom: '4px' }}>
                    ...
                    {group.items.map(item => {
                        ...
                        return <Link key={item.routeName} href={item.href} className="adm-sidebar-link" title={collapsed ? item.label : undefined} onClick={onClose}>
            ...
            <div style={{ padding: '8px 6px', borderTop: `1px solid ${t.sidebarBorder}`, flexShrink: 0 }}>
                <Link href="/" style={{ textDecoration: 'none', display: 'block' }} onClick={onClose}>
                ...
                <Link href="/logout" method="post" as="button" style={{ width: '100%', background: 'none', border: 'none', padding: 0, display: 'block', cursor: 'pointer' }}>
        ...
        <div style={{ position: 'fixed', top: 0, left: sidebarWidth, right: 0, zIndex: 150, height: '60px', background: dark ? t.topbar : '#FFFFFF', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', borderBottom: `1px solid ${t.border}`, display: 'flex', alignItems: 'center', padding: '0 16px', gap: '10px', transition: 'left .22s ease' }}>
            ...
            <div ref={searchRef} className="adm-topbar-search">
                ...
                {showResults && search.trim() && (
                    <div style={{ position: 'absolute', top: '100%', left: 0, right: 0, marginTop: '6px', background: t.cardSolid, border: `1px solid ${t.border}`, borderRadius: '12px', boxShadow: '0 12px 40px rgba(0,0,0,0.3)', padding: '6px', zIndex: 300 }}>
                        ...
                        {results.map(item => (
                            <Link key={item.routeName} href={item.href} onClick={() => { setSearch(''); setShowResults(false); }} style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '9px 12px', borderRadius: '8px', color: t.text, textDecoration: 'none', fontSize: '13px', fontWeight: '500', transition: 'background 0.12s' }}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginLeft: 'auto' }}>
                ...
                <div style={{ position: 'relative' }}>
                    <Link href="/admin/messages" style={{ width: '32px', height: '32px', borderRadius: '9px', background: t.input, border: `1.5px solid ${t.inputBorder}`, color: t.textMuted, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', lineHeight: 0, textDecoration: 'none' }}>
                ...
                <Link href="/admin/profile" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '6px', padding: '4px 10px 4px 4px', borderRadius: '50px', background: t.input, border: `1.5px solid ${t.inputBorder}`, cursor: 'pointer' }}>
